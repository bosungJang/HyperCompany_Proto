...
const DocumentType = () => {
  ...
  const [currentData, setcurrentData] = React.useState({
    id: "",
    title: "",
    desciption: "현금이 입금되는 거래를 표시하는 전표",
    useYn: "Y",
    account: [],
  });
  /* Current Data*/
      ...
      <div style={{ width: "inherit" }}>
        <ComponentWrapper>
          <div style={{ display: "block", marginTop: "40px" }}>
            ...
            <div
              style={{ display: "flex", marginTop: "39px", width: "inherit" }}
            >
              <HcTree
                items={items}
                title="전표 유형"
