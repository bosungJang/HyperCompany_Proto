...
const CardManagement = () => {
  ...
  const data = Array(55)
    ...
    .map(() => ({
      ...
      cardNickname: "팀회식비카드",
      cardCompany: "KB국민카드",
      cardClassification: "개인명의",
      owner: "홍길동",
      useYn: "사용",
      paymentAccount: "0000000-00000-00000000(KB국민은행)",
      paymentDate: "01",
    ...
    <>
      <div style={{ width: "inherit" }}>
        <ComponentWrapper style={{ width: "100%", minHeight: "972px" }}>
          ...
          >
            <HcTitleTextField titleName="카드 관리" isBackIcon={false} />
            <div
              className="table_area"
              style={{ marginTop: "59px", width: "inherit" }}
            >
              <TotalDataDiv>카드 목록(10)</TotalDataDiv>
              <div
                style={{
                  marginTop: "18px",
                  marginBottom: "20px",
