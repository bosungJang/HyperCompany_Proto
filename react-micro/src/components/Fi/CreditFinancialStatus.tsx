...
const CreditFinancialStatus = ({ match }: RouteComponentProps<MatchParams>) => {
  /*Tabs */
                    ...
                    "1": (
                      <>
                        <div style={{ marginTop: "20px", width: "inherit" }}>
                          <TotalDataDiv>전표 목록({data.length})</TotalDataDiv>
                          <div
                            style={{
                              marginTop: "26px",
                              marginBottom: "20px",
...
export default CreditFinancialStatus;
