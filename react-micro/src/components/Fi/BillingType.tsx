...
const BillingType = ({ match }: RouteComponentProps<MatchParams>) => {
  ...
  const [addedItem, setAddedItem]: any = React.useState([]);
      ...
      <>
        <div style={{ display: "block", width: "inherit", marginTop: "20px" }}>
          ...
          <div style={{ marginTop: "39px", width: "inherit" }}>
            <Input
              type={"text"}
              placeholder="비용 청구 유형 입력"
              style={{ width: "387px", height: "60px" }}
            />
            <VariableMultiLayout style={{ marginTop: "20px" }}>
              <p style={{ flexGrow: 1 }}>
                <div>
                  <CheckBoxTitle>법인 카드 사용 여부</CheckBoxTitle>
              ...
              <p style={{ flexGrow: 1 }}>
                <div>
                  <CheckBoxTitle>영수증 첨부 사용 여부</CheckBoxTitle>
                  <div style={{ marginTop: "20px" }}>
                    <HcRadioGroup
                      defaultValue={useYn}
                      onChange={(value) => {
              ...
              <p style={{ flexGrow: 1 }}>
                <div>
                  <CheckBoxTitle>지출결의서 첨부 사용 여부</CheckBoxTitle>
                  <div style={{ marginTop: "20px" }}>
                    <HcRadioGroup
                      defaultValue={useYn}
                      onChange={(value) => {
            ...
            <div style={{ marginTop: "74px" }}>
              ...
              >
                <HcButton
                  onClick={() => {
                    setAddedItem([...addedItem, { name: "", requiredYn: "" }]);
                  }}
                  styles="secondary"
                  size="medium"
                >
        ...
        >
          ...
          <HcTree
            items={items}
            style={{ minHeight: "814px", width: "514px", marginTop: "13px" }}
