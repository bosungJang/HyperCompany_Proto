      ...
      <div style={{ width: "inherit" }}>
        <ComponentWrapper style={{ width: "inheirt", display: "block" }}>
          <div style={{ display: "block", width: "inherit" }}>
            <div>
              <HcTitleTextField titleName="카드 승인 내역" isBackIcon={false} />
            </div>
            <div style={{ marginTop: "59px", width: "inherit" }}>
              <TotalDataDiv>카드 승인 내역(137)</TotalDataDiv>
              <div
                style={{
                  marginTop: "18px",
                  marginBottom: "20px",
