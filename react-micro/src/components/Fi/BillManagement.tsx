                    ...
                    <tbody>
                      {data.map(
                        ({
                          ...
                          >
                            <td style={{ width: "200px" }}>{billNumber}</td>
                            <td style={{ width: "160px" }}>{billAmount}</td>
                            <td style={{ width: "160px" }}>{balance}</td>
                            <td style={{ width: "160px" }}>{date}</td>
                            <td style={{ width: "160px" }}>{billType}</td>
                            <td style={{ width: "180px" }}>{receptionType}</td>
                            <td style={{ width: "160px" }}>{publisher}</td>
                            <td style={{ width: "160px" }}>{endorser}</td>
                            <td style={{ width: "160px" }}>{bankName}</td>
                          </tr>
                        )
                      )}
                    </tbody>
