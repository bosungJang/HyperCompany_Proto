...
export default function () {
  ...
  const [mail, setMail]: any = useState(
    `안녕하세요 ${location.state.name}님! \n ${location.state.company}입사를 진심으로 환영합니다! \nSuperComapny는 ${location.state.company}에서 사용하는 erp 플랫폼입니다. \n가입 후 요청받은 정보를 입력 및 업로드 완료하면, 인사 담당자에게 제출됩니다. \n이제 SuperComapny가 ${location.state.name}님의 편리한 회사 생활에 도움이 되어드릴게요!`
  );
