  ...
  return (
    ...
    >
      <div style={{ display: "flex", marginLeft: "auto" }}>
        ...
        <Btn onClick={props.setting} style={{ marginRight: 8 }}>
          {" "}
          <svg
            width="28"
            height="28"
        ...
        >
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M10.6248 3.72226C12.331 5.74671 12.0731 8.77103 10.0486 10.4773C8.02416 12.1835 4.99985 11.9255 3.29361 9.90108C1.58738 7.87663 1.84534 4.85231 3.8698 3.14607C5.89425 1.43984 8.91857 1.69781 10.6248 3.72226ZM11.7319 11.2896C13.9765 8.90314 14.1256 5.16043 11.9629 2.59447C9.63383 -0.169014 5.50549 -0.521152 2.74201 1.80794C-0.0214751 4.13704 -0.373613 8.26539 1.95548 11.0289C4.04514 13.5083 7.58313 14.0466 10.2843 12.449L13.962 16.8126C14.292 17.2041 14.8768 17.254 15.2683 16.924C15.6598 16.5941 15.7097 16.0092 15.3797 15.6177L11.7319 11.2896Z"
              fill="#5D5D62"
            />
          </svg>
        </Btn>{" "}
        <div
          style={{
            ...
            padding: "4px 10px",
            height: "30px",
            display: props.perPage ? "flex" : "none",
            fontSize: "15px",
            width: "fit-content ",
          }}
        >
